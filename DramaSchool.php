<html>
    ...
    <body>
       ...
       <h1>Drama School</h1>
        ...
        <div class = "firstColumn"> <!-- First Area Block -->
           <?php include_once 'calendar.php';?> <!-- Include the calendar -->
        ...
        <div class="split1"></div><!-- First Spilt, generated image -->
           <div class = "stack"> <!-- Second Area Block -->
            <h1>Audition Prep</h1>
        ...
        <div class="split2"></div>  <!-- Second Spilt, generated image -->
         <div class = "leftVid"> <!-- Third Area Block -->
         <h1>Before Audition</h1>

           <div class = "advice2"> <!-- Fourth Area Block -->
         ...
         <div class = "advice1"> <!-- Five Area Block -->
              <ul>
              <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</li> 
              <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</li> 
              <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</li> 
         ...
         <div class="split3"></div> <!-- Third Spilt, generated image -->
        <div class = "stack"> <!-- Sixth Area Block -->
         <h1>Warming up</h1>
        ...
        <div class="split4"></div> <!-- Fourth Spilt, generated image -->
        <div class = "leftVid"> <!-- Seventh Area Block -->
         <h1>Doing your Audition</h1>
            <div class = "advice2">
              <iframe  src="https://www.youtube.com/embed/64UW3Gmp5VA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
           </div>
          
          <div class = "advice1"> <!-- Eighth Area Block -->
            <ul>
              <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</li> 
              <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</li> 
              <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</li> 
